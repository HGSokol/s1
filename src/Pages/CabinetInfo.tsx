...
// update img
  ...
  <div className='mx-[16rem] lg:mx-[0rem]'>
        ...
        dataInfo.map((e,i) => {
          return(
            <div key={i} className='w-full lg:w-[441rem]'>
              <p className='font-bodyalt font-[400] text-[14rem] text-[#AAAAAA] leading-[19rem] mb-[12rem] lg:font-bodyalt lg:font-[400] lg:text-[16rem] lg:text-[#AAAAAA] lg:leading-[19rem] lg:mb-[14rem]'>{e.label}</p>
              <div className='flex items-center text-[14rem] hover:border-[#777872] outline-none w-full h-[50rem] px-[16rem] rounded-[8rem] bg-white border-[1px] border-[#1F211714] 
    ...
    <div className='w-full lg:w-[1000rem]'>
      <p className='font-bodyalt font-[600] text-[16rem] leaing-[19rem] text-[#1F2117] mb-[24rem] lg:font-body lg:font-[600] lg:text-[26rem] lg:text-[#1F2117] lg:leading-[30rem] lg:mb-[32rem]'>Изменение пароля</p>
      <div>
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-[20rem] w-full lg:flex-row lg:flex-wrap lg:gap-[20rem] lg:w-[1000rem]'>
          <div className='relative lg:w-[441rem]'>
            ...
            <p className='font-bodyalt font-[400] text-[14rem] text-[#AAAAAA] leading-[19rem] mb-[12rem] lg:mb-[14rem]'>Старый пароль</p>
            <input 
          ...
          <div className='relative lg:w-[441rem]'>
            ...
            <p className='font-bodyalt font-[400] text-[14rem] text-[#AAAAAA] leading-[19rem] mb-[12rem] lg:mb-[14rem]'>Введите новый пароль</p>
            <input 
          ...
          <div className='relative lg:flex lg:flex-col lg:w-[441rem]'>
            ...
            <p className='font-bodyalt font-[400] text-[14rem] text-[#AAAAAA] leading-[19rem] mb-[12rem] lg:mb-[14rem]'>Повторите новый пароль</p>
            <input 
              placeholder='Введите новый пароль' 
              type={`${type === true ? 'password' : 'text'}`}
              {...register("password2")} 
