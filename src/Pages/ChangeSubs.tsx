...
const Subs = () => {
  ...
  return (
    ...
    <div onClick={() => navigate(`${cardInfo ? '/cabinet/ordering2' : '/cabinet/ordering'}`)} className='mb-[20rem] w-full h-[50rem] flex justify-center items-center rounded-full bg-[#FFB700] text-[16rem] font-bodyalt font-[700] leading-[19rem] text-[#FFFFFF] lg:hidden'>
      Оплатить
    </div>
  </div>
  )
