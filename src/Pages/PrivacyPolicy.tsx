		...
		<>
			<div className="lg:w-[1920rem]">
				<div className="mx-[16rem] lg:mx-[120rem] overflow-hidden">
					<Header />
					<div className="lg:mr-[470rem]">
						<div className="font-body font-[600] text-[32rem] mb-[32rem] lg:text-[64rem] lg:leading-[75rem] text-[#1F2117] lg:mb-[64rem]">
							Политика Конфиденциальности
						</div>
						<div className='ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem] before:content-["1."] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]'>
							Общие положения
						</div>
						<div className="lg:ml-[34rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] lg:text-[20rem] lg:leading-[34rem] mb-[8rem] lg:mb-[16rem] ">
						...
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[32rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[48rem]">
							...
							<div className='mb-[8rem] lg:mb-[16rem] before:content-["1.2."] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]'>
								...
								пользователях мобильного приложения Фитнес Как Наука.
							</div>
						</div>
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['2.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
						...
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[32rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[48rem]">
							...
							<div className="before:content-['2.3.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								Мобильное приложение — совокупность графических и информационных материалов, а также
								программ для ЭВМ и баз данных, доступных для скачивания в магазинах приложений.
							</div>
							...
							<div className="before:content-['2.8.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								...
								определенному или определяемому Пользователю мобильного приложения Фитнес Как Наука.
							</div>
							...
							<div className="before:content-['2.10.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								Пользователь — любой пользователь мобильного устройства, который скачал мобильное
								приложение Фитнес Как Наука на свой телефон.
							</div>
						...
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['3.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
							Основные права и обязанности Оператора
						</div>
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[8rem] lg:text-[32rem] lg:leading-[34rem] lg:mb-[48rem]">
							<div className="">
								<div className="before:content-['3.1.'] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] lg:tracking-[0.05em] mb-[8rem] lg:mb-[16rem]">
									Оператор имеет право:
									<ul className="ml-[25rem] lg:ml-[40rem] list-disc list-outside  font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										<li className="">
							...
							<div className="">
								<div className="before:content-['3.2.'] mb-[32rem] lg:mb-[48rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] lg:tracking-[0.05em]">
									Оператор обязан:
									<ul className="ml-[25rem] lg:ml-[40rem] list-disc list-outside font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
										<li>
						...
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['4.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
							Основные права и обязанности субъектов персональных данных
						</div>
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[32rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[48rem]">
							<div className="">
								<div className="before:content-['4.1.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] lg:tracking-[0.05em]">
									Субъекты персональных данных имеют право:
									<ul className="ml-[25rem] lg:ml-[40rem] list-disc list-outside font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[8rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										<li>
							...
							<div className="">
								<div className="before:content-['4.2.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] lg:tracking-[0.05em]">
							...
							<div className="">
								<div className="before:content-['4.3.'] mb-[32rem] lg:mb-[48rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] lg:tracking-[0.05em]">
						...
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['5.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
						...
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['6.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
							Цели обработки персональных данных
						</div>
						<div className="mb-[32rem] lg:mb-[48rem]">
							<div className=" flex flex-col mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
								<div className="grid grid-rows-[42rem_h-min] lg:grid-cols-[387rem_820rem] pb-[24rem] border-b-[1rem] border-[#E4E4E4]">
									<div className="font-bodyalt font-[600] text-[22rem] leading-[32rem] text-[#1F2117] lg:pl-[33rem]">
										Цель обработки
									</div>
									<div>
								...
								<div className="grid grid-rows-[42rem_h-min] lg:grid-cols-[387rem_820rem] py-[24rem] border-b-[1rem] border-[#E4E4E4]">
									...
									<div>
										Фамилия, имя, отчество, год, месяц, дата и место рождения, рост, вес, параметры
										тела пользователя.
									</div>
								</div>
								<div className="grid grid-rows-[42rem_h-min] lg:grid-cols-[387rem_820rem] py-[24rem] border-b-[1rem] border-[#E4E4E4]">
									...
									<div>Уставные (учредительные) документы Оператора.</div>
								</div>
								<div className="grid grid-rows-[42rem_h-min] lg:grid-cols-[387rem_820rem] pt-[24rem]">
									<div className="whitespace-pre font-bodyalt font-[600] text-[22rem] leading-[32rem] text-[#1F2117] lg:pl-[33rem]">{`Виды обработки\nперсональных данных`}</div>
									<div>
										...
										Анализ использования мобильного приложения в целях улучшения качества и создания
										нового функционала.
									</div>
								</div>
							</div>
						</div>
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['7.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
							Условия обработки персональных данных
						</div>
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[8rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[16rem]">
						...
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['8.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
							Порядок сбора, хранения, передачи и других видов обработки персональных данных
						</div>
						<div className=" lg:ml-[34rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[8rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[16rem]">
						...
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[8rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[16rem]">
							...
							<div className="before:content-['8.3.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								...
								электронной почты Оператора privacy@fitnesskaknauka.ru с пометкой «Актуализация
								персональных данных».
							</div>
							<div className="before:content-['8.4.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								...
								privacy@fitnesskaknauka.ru с пометкой «Отзыв согласия на обработку персональных
								данных».
							</div>
							...
							<div className="before:content-['8.8.'] mb-[8rem] lg:mb-[16rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								Оператор осуществляет хранение персональных данных в форме, позволяющей определить
						...
						<div className="ml-[28rem] lg:ml-[34rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['9.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[34rem]">
						...
						<div className="ml-[28rem] lg:ml-[50rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['10.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[50rem]">
						...
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[8rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[16rem]">
							...
							<div className="before:content-['10.2.'] mb-[32rem] lg:mb-[48rem] before:absolute before:-translate-x-[33rem] lg:before:-translate-x-[52rem]">
								Оператор до подачи вышеуказанного уведомления, обязан получить от органов власти
						...
						<div className="ml-[28rem] lg:ml-[50rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['11.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[50rem]">
							Конфиденциальность персональных данных
						</div>
						<div className="lg:ml-[34rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[32rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[48rem]">
						...
						<div className="ml-[28rem] lg:ml-[50rem] font-bodyalt font-[600] text-[22rem] text-[#1F2117] leading-[26rem] mb-[20rem] lg:font-body lg:text-[32rem] lg:leading-[37rem] lg:mb-[24rem]  before:content-['12.'] before:absolute before:-translate-x-[28rem] lg:before:-translate-x-[50rem]">
							Заключительные положения
						</div>
						<div className="ml-[33rem] lg:ml-[86rem] font-bodyalt font-[400] text-[14rem] text-[#777872] leading-[21rem] mb-[100rem] lg:text-[20rem] lg:leading-[34rem] lg:mb-[160rem]">
