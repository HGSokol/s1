						...
						<div>
							<ol type="1" className="list-decimal list-inside text-[20rem]">
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[5rem]">
									Общие положения
									<div className="ml-[34rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[24rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
									...
									<ol className="ml-[86rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['1.1.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['1.2.'] before:absolute before:-translate-x-[52rem]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['2.1.'] before:absolute before:-translate-x-[52rem]">
											Автоматизированная обработка персональных данных — обработка персональных
											данных с помощью средств вычислительной техники.
										</li>
										<li className="before:content-['2.2.'] before:absolute before:-translate-x-[52rem]">
											Блокирование персональных данных — временное прекращение обработки
											персональных данных (за исключением случаев, если обработка необходима для
											уточнения персональных данных).
										</li>
										<li className="before:content-['2.3.'] before:absolute before:-translate-x-[52rem]">
											Мобильное приложение — совокупность графических и информационных материалов, а
											также программ для ЭВМ и баз данных, доступных для скачивания в магазинах
											приложений.
										</li>
										<li className="before:content-['2.4.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.5.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.6.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.7.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.8.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.9.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.10.'] before:absolute before:-translate-x-[52rem]">
											Пользователь — любой пользователь мобильного устройства, который скачал
											мобильное приложение Фитнес Как Наука на свой телефон.
										</li>
										<li className="before:content-['2.11.'] before:absolute before:-translate-x-[52rem]">
											Предоставление персональных данных — действия, направленные на раскрытие
											персональных данных определенному лицу или определенному кругу лиц.
										</li>
										<li className="before:content-['2.12.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.13.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['2.14.'] before:absolute before:-translate-x-[52rem]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] text-[16rem]">
										<li className="before:content-['3.1.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
											Оператор имеет право:
											<ul className="ml-[40rem] list-disc list-outside  font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
												<li className="">
										...
										<li className="before:content-['2.1.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
											Оператор обязан:
											<ul className="ml-[40rem] list-disc list-outside font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
												<li>
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] text-[16rem]">
										<li className="before:content-['4.1.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['4.2.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['4.3.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
											Лица, передавшие Оператору недостоверные сведения о себе, либо сведения о
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['5.1.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
											Обработка персональных данных осуществляется на законной и справедливой
											основе.
										</li>
										<li className="before:content-['5.2.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['5.3.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['5.4.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
											Обработке подлежат только персональные данные, которые отвечают целям их
											обработки.
										</li>
										<li className="before:content-['5.5.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['5.6.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['5.7'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<div className=" flex flex-col mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
										<div className="grid grid-cols-[387rem_820rem] pt-[24rem] border-b-[1rem] border-[#E4E4E4]">
											<div className="font-bodyalt font-[600] text-[22rem] leading-[32rem] text-[#1F2117] pl-[34rem]">
												Цель обработки
											</div>
											<div>
										...
										<div className="grid grid-cols-[387rem_820rem] py-[24rem] border-b-[1rem] border-[#E4E4E4]">
											<div className="font-bodyalt font-[600] text-[22rem] leading-[32rem] text-[#1F2117] pl-[34rem]">
												Персональные данные
											</div>
											<div>
										...
										<div className="grid grid-cols-[387rem_820rem] pt-[24rem]">
											<div className="whitespace-pre font-bodyalt font-[600] text-[22rem] leading-[32rem] text-[#1F2117] pl-[34rem]">{`Виды обработки\n персональных данных`}</div>
											<div>
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['7.1.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
											Обработка персональных данных осуществляется с согласия субъекта персональных
											данных на обработку его персональных данных.
										</li>
										<li className="before:content-['7.2.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['7.3.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['7.4.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['7.5.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['7.6.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
										...
										<li className="before:content-['7.7.'] before:absolute before:-translate-x-[52rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[16rem] lg:tracking-[0.05em]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<div className="ml-[34rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
									...
									<ol className="ml-[86rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['8.1.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.2.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.3.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.4.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.5.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.6.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.7.'] before:absolute before:-translate-x-[52rem]">
											Оператор при обработке персональных данных обеспечивает конфиденциальность
											персональных данных.
										</li>
										<li className="before:content-['8.8.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['8.9.'] before:absolute before:-translate-x-[52rem]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['9.1.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['9.2.'] before:absolute before:-translate-x-[52rem]">
											Оператор осуществляет автоматизированную обработку персональных данных с
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<ol className="ml-[86rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['10.1.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['10.2.'] before:absolute before:-translate-x-[52rem]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[20rem]">
									...
									<div className="ml-[34rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
								...
								<li className="font-body font-[600] text-[20rem] lg:text-[32rem] lg:leading-[37rem] text-[#1F2117] mb-[8rem] lg:mb-[150rem]">
									Заключительные положения
									<ol className="ml-[86rem] mt-[14rem] font-bodyalt font-[400] text-[16rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]'">
										<li className="before:content-['12.1.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['12.2.'] before:absolute before:-translate-x-[52rem]">
										...
										<li className="before:content-['12.3.'] before:absolute before:-translate-x-[52rem]">
