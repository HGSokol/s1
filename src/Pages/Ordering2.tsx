...
const Ordering = () => {
  ...
  return (
    ...
    <p className='mb-[24rem] font-bodyalt font-[600] text-[22rem] leading-[26rem] text-[#1F2117] lg:font-body lg:font-[600] lg:text-[26rem] lg:leaing-[30rem] lg:text-[#1F2117] lg:mb-[32rem]'>{ activeSub? 'Изменение платежных данных' :'Оформление заказа'}</p>
    <div className='lg:grid lg:grid-cols-[1fr_1fr] lg:w-full'>
        ...
        activeSub? null : (
          <div className='mb-[24rem] lg:order-2'>
            ...
            <div className='w-full flex flex-row justify-between mb-[12rem] lg:w-[357rem] lg:mb-[16rem]'>
              ...
              <div className='font-bodyalt font-[400] text-[16rem] text-[#1F2117] leading-[17rem] lg:text-[20rem] lg:leading-[23rem]'>{selectedPlan?.name}</div>
            </div>
      ...
      <div className={`lg:order-1 lg:w-[600rem] ${activeSub?' ': ' lg:border-r-[1px] lg:border-[#E4E4E4]'}`}>
        ...
        <div className='w-full lg:w-[441rem] '>
          ...
          <div >
            <button onClick={CreateYandexToken} disabled={load} className={`${load? ' bg-[#FFB700]/50': ' bg-[#FFB700]'} mb-[30rem] lg:mb-[24rem] w-full h-[51rem] flex items-center justify-center rem-[18rem] text-[16rem] text-white font-[600] rounded-[40rem] lg:h-[56rem] lg:py-[16rem] lg:rem-[24rem] lg:text-[16rem]`}>
