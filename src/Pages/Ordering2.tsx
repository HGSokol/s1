	...
	return (
		<div className="mx-[16rem] lg:mx-[0rem] lg:w-full">
			...
			<p className="mb-[24rem] font-bodyalt font-[600] text-[22rem] leading-[26rem] text-[#1F2117] lg:font-body lg:font-[600] lg:text-[26rem] lg:leaing-[30rem] lg:text-[#1F2117] lg:mb-[32rem]">
				{activeSub ? 'Изменение платежных данных' : 'Оформление заказа'}
			</p>
			<div className="lg:grid lg:grid-cols-[1fr_1fr] lg:w-full">
				...
				<div
					className={`lg:order-1 lg:w-[600rem] ${
						activeSub ? ' ' : ' lg:border-r-[1px] lg:border-[#E4E4E4]'
					}`}>
					...
					<div className="w-full lg:w-[441rem] ">
						...
						<p
							...
							className=" mb-[32rem] text-end font-bodyalt font-[500] text-[16rem] text-[#FFB700] leading-[14rem] cursor-pointer lg:text-[16rem] lg:leading-[19rem] lg:mb-[32rem]">
							Ввести данные другой карты
						</p>
						<div>
							<button
								onClick={CreateYandexToken}
								disabled={load}
								className={`${
