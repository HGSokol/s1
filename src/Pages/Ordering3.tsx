    ...
    lg:mt-[171rem]'>
      <div className='mb-[32rem]'>
        <svg className='w-[60rem] h-[60rem] lg:w-[78rem] lg:h-[78rem]' viewBox="0 0 61 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M30.5 57.7215C45.8102 57.7215 58.2215 45.3102 58.2215 30C58.2215 14.6898 45.8102 2.27848 30.5 2.27848C15.1898 2.27848 2.77848 14.6898 2.77848 30C2.77848 45.3102 15.1898 57.7215 30.5 57.7215ZM30.5 60C47.0685 60 60.5 46.5685 60.5 30C60.5 13.4315 47.0685 0 30.5 0C13.9315 0 0.5 13.4315 0.5 30C0.5 46.5685 13.9315 60 30.5 60Z" fill="#009245"/>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M43.0981 22.0002C43.5314 22.4563 43.513 23.1774 43.0568 23.6108L27.8669 38.0411C27.4272 38.4589 26.7373 38.4589 26.2976 38.0411L18.7027 30.8259C18.2465 30.3926 18.228 29.6715 18.6614 29.2153C19.0947 28.7592 19.8158 28.7407 20.272 29.174L27.0823 35.6438L41.4875 21.9589C41.9437 21.5255 42.6647 21.544 43.0981 22.0002Z" fill="#009245"/>
        </svg>
      </div>
    ...
    lg:mt-[171rem]'>
      <div className='mb-[32rem]'>
        <svg className='w-[60rem] h-[60rem] lg:w-[78rem] lg:h-[78rem]' viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M39 75.038C58.9032 75.038 75.038 58.9032 75.038 39C75.038 19.0968 58.9032 2.96203 39 2.96203C19.0968 2.96203 2.96203 19.0968 2.96203 39C2.96203 58.9032 19.0968 75.038 39 75.038ZM39 78C60.5391 78 78 60.5391 78 39C78 17.4609 60.5391 0 39 0C17.4609 0 0 17.4609 0 39C0 60.5391 17.4609 78 39 78Z" fill="#FFB700"/>
          <path d="M39 18V39.0004L56 56.0004" stroke="#FFB700" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
      <div className='mb-[24rem] font-body font-[600] text-[20rem] leading-[23rem] text-center text-[#1F2117]
