  ...
  return (
    <div onClick={() =>{
      ...
      <div className={` bg-white  h-max w-full py-[20rem] px-[20rem] overflow-hidden border-[1px] border-transparent cursor-pointer flex flex-col justify-between rounded-[20rem] 
        ${landing ? ' lg:h-[452rem]' : activeSub && activeSub.type === 'internal'? ' lg:h-[535rem]': ' lg:lg:h-[452rem]'} lg:w-full lg:py-[40rem] lg:px-[40rem] duration-[400ms] hover:border-[1px] ${active === 'active'? ' border-[#FFB700]': 'hover:border-[#CBCBCB]'}`}>
          {
