			...
			>
				...
				{button && (
					<div className="mt-[32rem] lg:mt-[0rem] order-4 flex flex-col lg:flex-row gap-[14rem] lg:gap-[20rem]">
						<div className="group/app cursor-pointer flex items-center justify-center rounded-[12rem] px-[18rem] lg:px-[24rem] py-[16rem] bg-[#16191C] duration-300 hover:bg-[#2e3134] text-[#FFFFFF] text-[16rem] leading-[19rem] font-bodyalt font-[600]">
						...
						<div className="group/google cursor-pointer flex items-center duration-300 hover:bg-[#ffb700] justify-center rounded-[12rem] px-[18rem] lg:px-[24rem] py-[16rem] text-[#16191C] text-[16rem] leading-[19rem] font-bodyalt font-[600] border-[1rem] hover:border-[#ffb700] border-[#16191C]">
