...
export const UpdateSubPopup = () => {
// 	const { activeSub, selectedPlan, setReload } = useContext(Profile);
// 	const navigate = useNavigate();
// 	const [cancelSub, setCancelSub] = useState<string | null>(null);
...
// 					setCancelSub(error.response.data.message);
// 				}
// 				// navigate('/cabinet');
// 			})
// 			.finally(() => {
...
// 	return (
// 		<div
// 			className={`flex flex-col w-[343rem] px-[16rem] pt-[32rem] lg:w-[604rem] rounded-[20rem] lg:px-[70rem] lg:py-[50rem] shadow-drop bg-white
//     ${cancelSub ? ' h-[200rem] lg:h-[250rem] ' : 'h-[251rem] lg:h-[308rem] '}`}>
// 			{cancelSub ? (
// 				<>
...
// 							setReload(true);
// 						}}
// 						className={`flex justify-center h-[56rem] items-center text-[16rem] leading-[19rem] lg:h-[56rem] lg:px-[24rem] lg:text-[16rem] text-[#FAFAFA] lg:leading-[19rem] font-bodyalt font-[400] rounded-full cursor-pointer hover:duration-[200ms] hover:bg-[#F0AD04] bg-[#FFB700]`}>
// 						Выход
// 					</button>
// 				</>
// 			) : (
