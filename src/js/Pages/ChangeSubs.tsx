		...
		<div className="mx-[16rem] lg:mx-[0rem]">
			{!didMount ? (
				...
				<>
					...
					<p className="mb-[32rem] font-bodyalt font-[600] text-[22rem] leading-[26rem] text-[#1F2117] lg:font-body lg:font-[600] lg:text-[26rem] lg:leaing-[30rem] lg:text-[#1F2117] lg:mb-[32rem]">
						Выберите подписку
					</p>
					...
					<div
						onClick={() => navigate('/cabinet/order')}
						className="mb-[20rem] w-full h-[50rem] flex justify-center items-center rounded-full bg-[#FFB700] text-[16rem] font-bodyalt font-[700] leading-[19rem] text-[#FFFFFF] lg:hidden cursor-pointer">
						Оплатить
					</div>
				</>
			)}
