					...
					<div className="lg:mr-[340rem]">
						...
						<div className="mb-[24rem] lg:mb-[48rem]">
							...
							<ul className="ml-[22rem] lg:ml-[27rem] list-disc list-outsude font-bodyalt font-[400] text-[14rem] leading-[21rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
								...
								<li>не нарушать работоспособность мобильного приложения.</li>
								<li>
									не создавать несколько учётных записей в мобильном приложении, если фактически они
						...
						<div className="mb-[32rem] lg:mb-[48rem]">
							...
							<ul className="ml-[22rem] lg:ml-[27rem] list-disc list-outsude font-bodyalt font-[400] text-[14rem] leading-[21rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
								...
								<li>
									осуществлять разностороннюю защиту учетной записи и данных предоставленных
									Пользователем во время пользования мобильным приложением.
								</li>
								<li>
						...
						<div className="mb-[32rem] lg:mb-[64rem]">
							...
							<ul className="ml-[22rem] lg:ml-[27rem] list-disc list-outsude font-bodyalt font-[400] text-[14rem] leading-[21rem] lg:text-[20rem] lg:leading-[34rem] text-[#777872] mb-[24rem] lg:mb-[48rem] lg:tracking-[0.05em]">
								...
								<li>
									любые публикации материалов, связанных с программой питания и/или программ
									физических тренировок несут строго рекомендательных характер. Придерживаться
									рекомендаций строго на усмотрение Пользователя мобильным приложением.
								</li>
								<li>
									Администрация не несет никакой ответственности в случае возникновения болезней
									и/или травм (в том числе повлекшие смерть или другие тяжкие последствия для
									организма) вследствие следования рекомендациям Администрации по выполнению тех или
									иных упражнений Пользователем.
								</li>
								<li>
