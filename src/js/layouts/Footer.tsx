          ...
          >
            ...
            >
              ...
              >
                ...
                lg:w-[22rem] lg:h-[22rem] bg-[#FFB700] group-hover/item3:bg-[#f1f1f1] group-hover/item3:fill-black"
                />
              </div>
            </a>
            <a
            ...
            >
              <div
                className="w-[36rem] h-[36rem] rounded-full grid place-items-center 
               lg:w-[44rem] lg:h-[44rem] bg-[#FFB700] group-hover/item1:bg-[#f1f1f1] group-hover/item1:border-[1rem] group-hover/item1:border-white"
              >
                <AiFillInstagram
                  className="w-[18rem] h-[18rem]
                lg:w-[22rem] lg:h-[22rem] bg-[#FFB700] group-hover/item1:bg-[#f1f1f1] group-hover/item1:fill-black"
                />
              </div>
            </a>
            <a
            ...
            >
              <div
                className="w-[36rem] h-[36rem] rounded-full grid place-items-center 
               lg:w-[44rem] lg:h-[44rem] bg-[#FFB700] group-hover/item2:bg-[#f1f1f1] group-hover/item2:border-[1rem] group-hover/item2:border-white"
              >
                <FaTelegramPlane
                  className="w-[18rem] h-[18rem]
                lg:w-[22rem] lg:h-[22rem] bg-[#FFB700] group-hover/item2:bg-[#f1f1f1] group-hover/item2:fill-black"
                />
              </div>
            </a>
            <a
