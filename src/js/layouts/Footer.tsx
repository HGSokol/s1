  ...
  return (
    ...
    >
      <div className="contents lg:flex flex-col lg:flex-row">
        <div
          className="order-1 lg:order-none mx-auto mb-[40rem] 
      lg:mx-0 lg:flex lg:items-center  lg:mr-[100rem] lg:mb-[0rem]"
        >
          <svg
            viewBox="0 0 126 56"
            fill="none"
        ...
        <div className="order-4 lg:order-none mx-auto lg:mr-[721rem] flex flex-col gap-[24rem] lg:items-start lg:justify-center lg:mx-0 lg:my-auto lg:gap-[16rem]">
          <div className="text-white flex flex-col lg:flex-row gap-[16rem] items-center">
            <div className="flex flex-row justify-center gap-[8rem]">
              ...
              <div className="font-[400] font-body text-[16rem] lg:text-[18rem] text-[#CBCBCB] leading-[22rem] lg:leading-[21rem]">
                6141058830
              </div>
            </div>
            ...
            <div className="flex flex-row gap-[8rem] mb-[24rem] lg:mb-[0rem] ">
              <div className="font-[700] font-body text-[16rem] lg:text-[18rem] text-[#CBCBCB] leading-[19rem] lg:leading-[21rem]">
                КПП
              </div>
              <div className="font-[400] font-body text-[16rem] lg:text-[18rem] text-[#CBCBCB] leading-[22rem] lg:leading-[21rem]">
        ...
        <div
          className="order-2 lg:order-none flex flex-col items-center justify-center w-[256rem] mx-auto
       lg:mx-0 lg:w-auto lg:h-[56rem] lg:mb-[0rem] lg:items-end"
        >
          <div
            className="mb-[32rem] flex flex-row gap-[16rem] items-center justify-center items-self-start
        lg:gap-[16rem] lg:mb-0"
          >
            <a
            ...
            >
              <div
               ...
               lg:w-[44rem] lg:h-[44rem] bg-[#FFB700] group-hover/item3:bg-black group-hover/item3:border-[1rem] group-hover/item3:border-white"
              >
                <FaFacebookF
                  className="w-[18rem] h-[18rem]
                lg:w-[22rem] lg:h-[22rem] bg-[#FFB700] group-hover/item3:bg-black group-hover/item3:fill-white"
                />
              </div>
            </a>
            <a
            ...
            >
              <div
                className="w-[36rem] h-[36rem] rounded-full grid place-items-center 
               lg:w-[44rem] lg:h-[44rem] bg-[#FFB700] group-hover/item1:bg-black group-hover/item1:border-[1rem] group-hover/item1:border-white"
              >
                <AiFillInstagram
                  className="w-[18rem] h-[18rem]
                lg:w-[22rem] lg:h-[22rem] bg-[#FFB700] group-hover/item1:bg-black group-hover/item1:fill-white"
                />
              </div>
            </a>
            <a
            ...
            >
              <div
                className="w-[36rem] h-[36rem] rounded-full grid place-items-center 
               lg:w-[44rem] lg:h-[44rem] bg-[#FFB700] group-hover/item2:bg-black group-hover/item2:border-[1rem] group-hover/item2:border-white"
              >
                <FaTelegramPlane
                  className="w-[18rem] h-[18rem]
                lg:w-[22rem] lg:h-[22rem] bg-[#FFB700] group-hover/item2:bg-black group-hover/item2:fill-white"
                />
              </div>
            </a>
            <a
      ...
      <div className="contents lg:flex flex-col lg:flex-row gap-[50rem] whitespace-nowrap">
        <div className="order-5 lg:order-none font-[400] font-body text-[16rem] text-[#FFFFFF] lg:leading-[19rem] leading-[22rem]">
        ...
        <div className="mb-[40rem] lg:mb-[0rem] order-3 lg:order-none flex flex-col lg:flex-row lg:gap-[50rem]">
          <div
            ...
            className="lg:mr-[525rem] font-body font-[400] text-[16rem] leading-[22rem] text-white
        lg:leading-[19rem] lg:text-[16rem] mb-[16rem] lg:mb-[12rem] cursor-pointer"
          ...
          <div
            ...
            className="font-body font-[400] text-[16rem] mb-[12rem] leading-[22rem] text-white
        lg:leading-[19rem] lg:text-[16rem] cursor-pointer"
          ...
          <div
            onClick={() => navigate("/policy")}
            className="font-body font-[400] text-[16rem] leading-[22rem] text-white
        lg:leading-[19rem] lg:text-[16rem] cursor-pointer"
          >
