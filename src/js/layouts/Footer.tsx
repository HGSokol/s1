...
export const Footer = () => {
    ...
    return (
        <div
            className="bg-black h-[454rem] py-[32rem] flex flex-col
    lg:flex-row lg:h-[206rem] lg:py-[48rem] lg:px-[120rem]"
        >
            <div
                className="order-1 mx-auto mb-[40rem]
            ...
            <div className="mx-auto order-3 lg:order-2 lg:mr-[700rem] flex flex-col gap-[24rem] lg:items-start lg:justify-center lg:mx-0 lg:my-auto lg:gap-[16rem]">
                <div className="text-white flex flex-col lg:flex-row gap-[16rem] items-center">
                    <div className="flex flex-row gap-[8rem]">
                        ...
                        <div className="font-[300] font-bodyalt text-[16rem] text-[#CBCBCB] leading-[19rem]">
                            6141058830
                        </div>
                    </div>
                    <div className="flex flex-row gap-[8rem]">
               ...
               lg:w-[36rem] lg:h-[36rem] bg-white group-hover/item2:bg-black group-hover/item2:border-[1rem] group-hover/item2:border-white">
                ...
                lg:w-[18rem] lg:h-[18rem] bg-white group-hover/item2:bg-black group-hover/item2:fill-white"
                    ...
                    >
                        <div
                            className="w-[36rem] h-[36rem] rounded-full  grid place-items-center 
               lg:w-[36rem] lg:h-[36rem] bg-[#FFB700] group-hover/item3:bg-black group-hover/item3:border-[1rem] group-hover/item3:border-white"
                        >
                            <HiMail
                                className="w-[18rem] h-[18rem]
                lg:w-[18rem] lg:h-[18rem] bg-[#FFB700] group-hover/item3:bg-black group-hover/item3:fill-white"
                            />
                        </div>
                    </a>
                </div>
