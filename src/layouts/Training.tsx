...
export const Training = () => {
  ...
  return (
    <div id='training' className='grid grid-rows-[340rem_auto] mb-[117rem] grid-cols-1 
    lg:grid-cols-[auto_auto] lg:grid-rows-1 lg:mb-[169rem] lg:pt-[20rem]'>
      <div className='lg:pt-[120rem]'>
        <div className='mb-[25rem] flex flex-row gap-[8rem] 
        ...
        <h2 className='whitespace-pre-wrap font-[600] text-[36rem] leading-[42rem] h-[126rem] mb-[24rem] text-[#1F2117] 
        lg:text-[64rem] lg:leading-[75.14rem] lg:w-[842rem] lg:h-[150rem] lg:mb-[32rem]'>{`Тренируйся. ${window.innerWidth<1024 ? ' \n':''}Будь сильнее. ${window.innerWidth<1024 ? ' \n':''}Укрепи здоровье.`}</h2>
        <div className='font-bodyalt font-[400] text-[16rem] leading-[19rem] h-[76rem] tracking-[0.02em] 
        lg:text-[22rem] lg:leading-[32rem] text-[#777872] lg:w-[734rem] lg:h-[128rem]'>Уровень твоей подготовки не имеет значения. Наши программы выстроены под любой уровень физической подготовки.&nbsp;
          <div className='inline-block relative'>
            <div className='z-10 relative'>
              Более чем 1500&nbsp;
            </div>
            <div className='-z-0 absolute'>
              <svg className='w-[130rem] h-[10rem] -translate-y-[5rem] -translate-x-[2rem] 
