...
export const Training = () => {
  ...
  lg:grid-cols-[auto_auto] lg:grid-rows-1 lg:mb-[169px]
  2lg:grid-cols-[auto_auto] 2lg:grid-rows-1 2lg:mb-[169px]'>
    <div className='
    lg:pt-[90px]
    2lg:pt-[90px] '>
      <div className='flex flex-row gap-[8px]
      lg:mb-[32px] lg:gap-[10px]
          ...
          data.map((item,i) => {
            return (
              <button 
                ...
                lg:text-[16px] lg:leading-[19px] lg:w-[132px] lg:h-[43px] lg:mr-[10px] lg:px-[0px] lg:py-[0px]
      ...
      2lg:text-[22px] 2lg:leading-[32px]  2lg:w-[734px] 2lg:h-[128px] '>Уровень твоей подготовки не имеет значения. Наши программы выстроены под любой уровень физической подготовки.&nbsp;
        <div className='inline-block relative'>
          ...
          <div className='-z-0 absolute'>
            ...
            lg:w-[170px] lg:h-[20px] lg:-translate-y-[13px] lg:-translate-x-[3px]
      ...
      <div className='order-last relative mx-auto'>
        ...
        lg:translate-x-[408px] lg:w-[118px] lg:h-[108px] lg:-translate-y-[10px]
        ...
        lg:-translate-x-[90px] lg:w-[103px] lg:h-[99px] lg:translate-y-[480px]
        ...
        lg:translate-x-[190px] lg:w-[59px] lg:h-[61px] lg:-translate-y-[0px]
        ...
        lg:translate-x-[245px] lg:w-[59px] lg:h-[61px] lg:translate-y-[570px]
        ...
        lg:-translate-x-[10px] lg:w-[555px] lg:h-[107px] lg:translate-y-[630px]
