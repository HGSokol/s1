...
export const Article = () => {
  ...
  2lg:grid-cols-[1fr_1fr] 2lg:grid-rows-1 2lg:mb-[150px]'>
    ...
    lg:order-1'>
      ...
      lg:translate-x-[430px] lg:w-[118px] lg:h-[108px] lg:-translate-y-[35px]
      ...
      lg:-translate-x-[70px] lg:w-[103px] lg:h-[99px] lg:translate-y-[470px]
      ...
      lg:translate-x-[210px] lg:w-[59px] lg:h-[61px] lg:-translate-y-[20px]
      ...
      lg:translate-x-[270px] lg:w-[59px] lg:h-[61px] lg:translate-y-[560px]
      ...
      lg:translate-x-[0px] lg:w-[555px] lg:h-[107px] lg:translate-y-[620px]
      ...
      lg:w-[537px] lg:h-[607px] lg:mx-auto
          ...
          data.map((item,i) => {
            return (
              <button 
                ...
                lg:w-[132px] lg:h-[43px] lg:mr-[10px] lg:text-[16px] lg:leading-[19px] lg:px-[0px] lg:py-[0px]
      ...
      2lg:text-[22px] 2lg:leading-[32px] text-[#777872] 2lg:w-[734px] 2lg:h-[128px]'>В нашем приложение собраны 
        <div className='inline-block relative'>
          ...
          <div className='-z-0 absolute'>
            ...
            lg:w-[167px] lg:h-[17px] lg:-translate-y-[11px] lg:-translate-x-[3px]
