  ...
  return (
    ...
    lg:grid-cols-[1fr_1fr] lg:grid-rows-1 lg:mb-[150rem]'>
      <div className='lg:pt-[90rem]'>
        ...
        lg:text-[22rem] lg:leading-[32rem] text-[#777872] lg:w-[734rem] lg:h-[128rem]'>Отмечай каждую тренировку и просматривай статистику. Отслеживание прогресса&nbsp;
          <div className='inline-block relative'>
            <div className='z-10 relative'>
            стало проще&nbsp;
            </div>
            <div className='-z-0 absolute'>
              <svg className='w-[100rem] h-[10rem] -translate-y-[5rem] -translate-x-[5rem]  
