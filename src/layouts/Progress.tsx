...
export const Progress = () => {
  ...
  lg:grid-cols-[1fr_1fr] lg:grid-rows-1 lg:mb-[150rem]'>
      ...
      lg:pt-[90rem] lg:mb-[32rem] lg:gap-[18rem]'>
        {
          data.map((item,i) => {
            return (
              <button 
                key={i}
                className={`hover:bg-[#FFB700] hover:text-[#FAFAFA] bg-white font-bodyalt w-max h-[30rem] px-[12rem] py-[8rem] text-[12rem] rem-[12rem] leading-[14.32rem] rounded-[40rem] font-[400] duration-[600ms] whitespace-nowrap
    ...
    <div className='relative order-last mx-auto lg:mx-[0]'>
