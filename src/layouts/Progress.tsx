...
export const Progress = () => {
  ...
  <div className='grid grid-rows-[h-max_h-min] grid-cols-1 mb-[120px] md:grid-cols-[1fr_1fr] md:mb-[150px]'>
    <div className='md:pt-[90px]'>
      <div className='mb-[24px] md:mb-[32px] flex flex-row gap-[8px] md:mr-[10px]'>
        {
          data.map((item,i) => {
            return (
              <button 
                key={i}
                className={`font-bodyalt w-max h-[30px] py-[8px] text-[12px] px-[12px] leading-[14.32px]  md:w-[132px] md:h-[43px] rounded-[40px] font-[400] md:text-[16px] md:leading-[19px] duration-[600ms]
      ...
      <p className='font-bodyalt font-[400] text-[14px] leading-[16.71px] md:text-[22px] md:leading-[32px] text-[#777872] md:w-[734px] md:h-[128px] tracking-[0.02em]'>Отмечай каждую тренировку и просматривай статистику.
