...
const data: buttonName = [
  ...
  export const Food = () => {
    ...
    return (
      <div id='food' className='relative grid grid-rows-[auto_auto] grid-col-1 mb-[100rem] 
      lg:grid-cols-[1fr_1fr] lg:grid-rows-1 lg:mb-[150rem] lg:pt-[45rem]'>
        <div className='mt-[30rem] relative order-2 mx-auto 
        lg:order-1 lg:mx-[0]'>
          <div className='z-10 absolute w-[54rem] h-[47rem] translate-x-[250rem] translate-y-[5rem] 
          lg:translate-x-[515rem] lg:w-[118rem] lg:h-[108rem] lg:-translate-y-[30rem]'><img src={frameInteractive[active].img1} alt='heart'/></div>
          <div className='absolute w-[55rem] h-[53rem] -translate-x-[10rem] translate-y-[260rem] 
          lg:translate-x-[15rem] lg:w-[103rem] lg:h-[99rem] lg:translate-y-[470rem]'><img src={frameInteractive[active].img2} alt='frame'/></div>
          <div className='absolute w-[31rem] h-[32rem] translate-x-[125rem] translate-y-[10rem] 
          lg:translate-x-[295rem] lg:w-[59rem] lg:h-[61rem] lg:-translate-y-[10rem]'><img src={Group} alt='group'/></div>
          <div className='absolute w-[31rem] h-[32rem] translate-x-[155rem] translate-y-[310rem] 
          lg:translate-x-[355rem] lg:w-[59rem] lg:h-[61rem] lg:translate-y-[560rem] rotate-[180deg]'><img src={Group} alt='group'/></div>
          <div className='absolute w-[280rem] h-[10rem] translate-x-[15rem] translate-y-[330rem] 
          lg:translate-x-[80rem] lg:w-[555rem] lg:h-[107rem] lg:translate-y-[620rem]'><img src={Shadow} alt='ellipse'/></div>
          <img className ='z-0 w-[320rem] mx-auto 
          lg:h-[656rem] lg:w-[594rem] lg:mx-auto  lg:-translate-x-[60rem] lg:-translate-y-[20rem]' src={IMG2} alt='eat1'/>
        </div>
        ...
        lg:pt-[90rem] lg:order-2'>
          ...
          <h2 className='font-[600] text-[36rem] leading-[42rem] h-[126rem] mb-[24rem] text-[#1F2117] 
        ...
        lg:text-[22rem] lg:leading-[32rem] text-[#777872] lg:w-[734rem] lg:h-[128rem]'>Ежедневный индивидуальный план питания с учетом вашего здоровья, образа жизни и целей.&nbsp;
            <div className='inline-block relative'>
              <div className='z-10 relative'>
              Более 1000&nbsp;
              </div>
              <div className='-z-0 absolute'>
                <svg className='w-[100rem] h-[12rem] -translate-y-[5rem] -translate-x-[8rem] 
