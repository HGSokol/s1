...
export const Food = () => {
  ...
  lg:grid-cols-[1fr_1fr] lg:grid-rows-1 lg:mb-[150px]
  2lg:grid-cols-[1fr_1fr] 2lg:grid-rows-1 2lg:mb-[150px]'>
    ...
    2lg:order-1 2lg:mx-[0]'>
      ...
      lg:translate-x-[515px] lg:w-[118px] lg:h-[108px] lg:-translate-y-[30px]
      ...
      lg:translate-x-[15px] lg:w-[103px] lg:h-[99px] lg:translate-y-[470px]
      ...
      lg:translate-x-[295px] lg:w-[59px] lg:h-[61px] lg:-translate-y-[10px]
      ...
      lg:translate-x-[355px] lg:w-[59px] lg:h-[61px] lg:translate-y-[560px] 
      ...
      lg:translate-x-[80px] lg:w-[555px] lg:h-[107px] lg:translate-y-[620px]
          ...
          data.map((item,i) => {
            return (
              <button 
                ...
                lg:w-max lg:h-[43px] lg:text-[16px] lg:leading-[19px] lg:px-[20px] lg:py-[0px]
      ...
      2lg:text-[22px] 2lg:leading-[32px] 2lg:w-[734px] 2lg:h-[128px] '>Ежедневный индивидуальный план питания с учетом вашего здоровья, образа жизни и целей.&nbsp;
        <div className='inline-block relative'>
          ...
          <div className='-z-0 absolute'>
            ...
            lg:w-[140px] lg:h-[20px] lg:-translate-y-[13px] lg:-translate-x-[14px]
