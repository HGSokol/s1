        ...
        lg:mb-[32rem] lg:w-[814rem] lg:gap-[18rem]'>
          {
            data.map((item,i) => {
              return (
                <button 
                  key={i}
                  className={`hover:bg-[#FFB700] hover:text-[#FAFAFA] bg-white font-bodyalt py-[8rem] rem-[12rem] w-max px-[12rem] text-[12rem] leading-[14.32rem] rounded-[40rem] font-[400] duration-[600ms] whitespace-nowrap
