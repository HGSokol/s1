								...
								return (
									<div key={i} onClick={() => setActive((prev) => e.link)}>
										<Link to={`/cabinet${e.link}`}>
											<div
												className={`lg:hover:bg-gray-200 hover:duration-[200ms] lg:pl-[20rem] lg:w-[200rem] h-full gap-[6rem] flex flex-col justify-center items-center lg:flex-row lg:justify-start lg:items-center lg:gap-[24rem] lg:mb-[47rem] lg:group/link lg:rounded-[15rem]`}>
