  ...
  return (
    ...
    2lg:gap-[15px] 2lg:mb-[150px]'>
      ...
      2lg:mb-[64px] '>
        ...
        lg:leading-[35px] lg:text-[33.92px]
      ...
      <div 
        ...
        md:h-[345px] 
        lg:h-[180px] lg:snap-none lg:overflow-visible
        2lg:h-[330px] '
        ...
        data.map((e,i) => {
          return(
            <div ref={ref} key={i} className='snap-center'>
              ...
              lg:w-[265px] lg:h-[169.07px] lg:p-[13px] lg:flex lg:flex-col lg:justify-between
              2lg:w-[500px] 2lg:h-[319px] 2lg:p-[24px] 2lg:flex 2lg:flex-col'>
                ...
                2lg:grid 2lg:grid-cols-2'>
                  ...
                  lg:order-2 lg:justify-end lg:items-end lg:mb-[0px]
                  ...
                  2lg:order-1 2lg:gap-[14px]'>
                    ...
                    <div className='flex flex-col justify-center'>
                      ...
                      lg:font-[500] lg:text-[9.5px] lg:leading-[11px] lg:mb-[3px]
