    ...
    style={{marginBottom: `${active !== null ? '150px': '0px'}`}}>
      <div className='flex flex-row mb-[32rem] space-x-[200rem] justify-between lg:mb-[64rem]'>
        ...
        lg:flex lg:flex-row lg:gap-[10rem]'>
          ...
          <button className='rounded-full border-[1px] border-[#1F2117] w-[56rem] h-[56rem] text-black grid place-content-center mr-[120rem] cursor-pointer group/arrow2 bg-[#FFB700] hover:bg-[#F0AD04] border-none duration-[200ms] 
                    ...
                    lg:${active === i? 'visible' : 'hidden'} z-5`}>
                      ...
                      lg:gap-[12rem]'>
                        <a href={e.links.instagram} target='_blank' rel="noreferrer">
                          <div className='w-[40rem] h-[40rem] flex justify-center items-center bg-white rounded-[10rem] p-[5rem] group/inst hover:bg-black delay-[100ms] duration-[400ms]
                           lg:w-[48rem] lg:h-[48rem]'>
                            <AiFillInstagram size='30px' className='w-[32rem] h-[32rem] fill-black group-hover/inst:fill-white delay-[100ms] duration-[400ms]
                        ...
                        <a href={e.links.youtube} target='_blank' rel="noreferrer">
                          <div className='w-[80rem] h-[40rem] bg-white rounded-[10rem] overflow-hidden flex justify-center items-center
                            ...
                            <ImYoutube2 size='70px' className='w-[60rem] h-[32rem] fill-black group-hover/telega:fill-white delay-[100ms] duration-[400ms]
