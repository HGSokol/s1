  ...
  return (
    ...
    2lg:gap-[15px] 2lg:mb-[50px] 2lg:overflow-hidden'>
      ...
      2lg:mb-[64px]'>
        ...
        lg:text-[64px] lg:leading-[75.14px]
          ...
          return(
            ...
            2lg:grid-rows-[420px_150px] '>
              <div 
                ...
                lg:h-[420px] 
                2lg:h-[420px] 
                ${active === i? ' lg:w-[530px] 2lg:w-[530px]': ' lg:w-[255px] 2lg:w-[255px]' }`}
                ...
                lg:leading-[32.71px] lg:pl-[20px] lg:pt-[20px] lg:text-[22px] 
