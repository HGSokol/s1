...
export const About = () => {
    ...
    lg:mb-[195rem]">
			<p
				className="text-[36rem] mb-[32rem] leading-[42rem] font-[600] text-[#1F2117]
      lg:block lg:text-[64rem] lg:leading-[75rem] lg:mb-[75rem]">
				О приложении
			</p>
			<div
				className="grid grid-rows-[1fr] gap-[16rem] mb-[72rem] 
